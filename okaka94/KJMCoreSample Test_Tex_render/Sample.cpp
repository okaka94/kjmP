...
bool Sample::Init()
{
	...
	Main_cam.Create_View_matrix(Vector(0,0,-30), Vector(0, 0, 0), Vector(0, 1, 0));
	Main_cam.Create_Proj_matrix(1.0f, 100.0f, PI * 0.5f, (float)g_rtClient.right / (float)g_rtClient.bottom);
